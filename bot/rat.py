...
token="MTAyMDM1OTg0NTU5NTA1NDA4MA.GLPdny.5NKYNxTBGhEB85cs6eaEP6ML4twQp4pFCdwfq8"
...
@tree.command(name="工作",description="賺錢",guilds=guild_obj_list)
...
@tree.command(name="選工作",description="選擇你的職業",guilds=guild_obj_list)
async def self(interaction:discord.Interaction):
