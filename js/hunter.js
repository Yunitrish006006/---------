...
window.onload = function(){
    ...
    startSound.src = "../sounds/whistlestart.ogg";
    startSound.volume = 0.6;
            
    var shootSound = new Audio();
    shootSound.src = "../sounds/arrow.ogg";
            
    var hitSound = new Audio();
    hitSound.src = "../sounds/arrowhit.ogg";
    ...
    endSound.src = "../sounds/whistleover.ogg";
    endSound.volume = 0.6;
            
    var successSound = new Audio();
    successSound.src = "../sounds/centerhit.ogg";
            
    var highScoreSound = new Audio();
    highScoreSound.src = "../sounds/crowdcheer.ogg";
